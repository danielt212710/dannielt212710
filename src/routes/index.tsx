...
const title = "Daniel Tuba — Frontend Engineer & Creative Developer";
const description =
  "Portfolio of Daniel Tuba, a frontend engineer building immersive, high-performance interfaces with React, WebGL and motion.";
